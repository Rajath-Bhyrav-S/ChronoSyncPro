...
//
//import com.cryptosoft.dtos.LoginRequest;
//import com.cryptosoft.service.AuthenticationService;
//
//@RestController
//@RequestMapping("/auth")
...
//    @PostMapping("/login")
//    public ResponseEntity<?> login(@RequestBody LoginRequest loginRequest) {
//        AuthenticationRequest authRequest = new AuthenticationRequest(loginRequest.getEmail(), loginRequest.getPassword());
//        return ResponseEntity.ok(authenticationService.authenticateUserAndCreateCookie(authRequest, null));
//    }
//}
